...
<html>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <button type="button" class="btn btn-outline-primary"><a href="logout.jsp"> Sair </a></button>
  </div>
</nav>
    
    <div class="container">
         
        <button class="btn-info" data-toggle="modal" data-target="#Inserir">Novo Usuário</button>
                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="cadastro-form" class="form" action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" name="btn-salvar" class="btn-primary"> Salvar </button>
                            </div>
                            </div>
                        </form>
